		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo ('Edit Accountant');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo ('Accountant List');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo ('Add Accountant');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_accountant/edit/do_update/'.$row['accountant_id'] , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary"><?php echo ('Save Accountant');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive table-hover">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo ('Accountant Name');?></div></th>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_accountant/create/' , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-success"><?php echo ('Add Accountant');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>
